...
Дополнительно настроена защита от спама и ботов при отправке обращения через форму на сайте:  
- добавлено скрытое поле
- добавлена валидация полей ввода текста на стравнение со списком запрещенных слов, тегов и других потенциально опасных вещей
